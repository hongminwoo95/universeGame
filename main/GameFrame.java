...
//	}
	...
	public void hitPlayerU(int i) { // 플레이어와 적기의 충돌
		if (y <= enemyListU.get(i).getenemyY() + enemyListU.get(i).getenemyHeight()
				&& y + player.getPlayerHeight() >= enemyListU.get(i).getenemyY()
