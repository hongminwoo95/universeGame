...
public class GameFrame extends JFrame implements KeyListener, Runnable{
	...
	private int playersstop = 0; // player 멈추기
	
	Toolkit tk = Toolkit.getDefaultToolkit(); // 이미지를 불러오기 위한 톨킷
	
	private Image background; // 화염행성 배경 
	...
	public void init() { // 이미지 각종 이미지
		background = new ImageIcon("images/화염행성.png").getImage(); // 맵 이미지 생성
	...
	public void paint(Graphics g) {
		...
		buffg.drawImage(playerL, x, y, this); // 첫 시작 위치
		update(g);
	}
	...
	public void Draw_Player() {
		...
		buffg.drawImage(playerL, x, y, 100, 100, this);
